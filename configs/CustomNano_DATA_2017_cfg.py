...
# with command line options: --eventcontent NANOAOD --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=1000 --datatier NANOAOD --conditions 106X_dataRun2_v35 --step NANO --era Run2_2017,run2_nanoAOD_106Xv2 --python_filename configs/CustomNano_DATA_2017_cfg.py --filein file:dummy.root --fileout file:NANOAOD.root --no_exec --data -n -1
