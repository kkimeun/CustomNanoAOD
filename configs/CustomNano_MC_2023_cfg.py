...
# with command line options: --eventcontent NANOAODSIM --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=1000 --scenario pp --datatier NANOAODSIM --conditions 130X_mcRun3_2023_realistic_v14 --step NANO --era Run3_2023 --python_filename configs/CustomNano_MC_2023_cfg.py --filein file:dummy.root --fileout file:NANOAOD.root --no_exec --mc -n -1
