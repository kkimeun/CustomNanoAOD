...
# with command line options: --eventcontent NANOAODSIM --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=1000 --datatier NANOAODSIM --conditions 106X_mcRun2_asymptotic_preVFP_v11 --step NANO --era Run2_2016_HIPM,run2_nanoAOD_106Xv2 --python_filename configs/CustomNano_MC_2016preVFP_cfg.py --filein file:dummy.root --fileout file:NANOAOD.root --no_exec --mc -n -1
