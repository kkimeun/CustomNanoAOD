...
# with command line options: --eventcontent NANOAOD --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=1000 --scenario pp --datatier NANOAOD --conditions 130X_dataRun3_PromptAnalysis_v1 --step NANO --era Run3_2023 --python_filename configs/CustomNano_DATA_2023BPix_cfg.py --filein file:dummy.root --fileout file:NANOAOD.root --no_exec --data -n -1
